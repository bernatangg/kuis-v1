...
<div id="wrapper">
    <aside id="sideBar">
        <ul class="main-nav">
            ...
            <li class="nav-brand">
                <a href="/">CBM QUIZ - Home</a>
            </li>
            <li>
                <a href="{{ route('pertanyaan.create') }}">- Tambah Pertanyaan</a>
            </li>
            <li>
                <a href="{{ route('pertanyaan.store') }}">- Daftar Pertanyaan</a>
            </li>
            <li>
                <a href="{{ route('kuis.showpertanyaan') }}">- KUIS</a>
            </li>
        </ul>
    </aside>
